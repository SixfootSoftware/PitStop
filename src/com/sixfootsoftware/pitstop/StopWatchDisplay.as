...
package com.sixfootsoftware.pitstop {
    ...
    public class StopWatchDisplay extends FlxSprite {
        ...
        public function StopWatchDisplay() {
            ...
            this.addAnimation("5", [7,1,7,1,7,1,7], 4, false);
            this.addAnimation("4", [4,7,4,7,4,7,4], 4, false);
            this.addAnimation("3", [2,4,2,4,2,4,2], 4, false);
            this.addAnimation("2", [6,2,6,2,6,2,6], 4, false);
            this.addAnimation("1", [3,6,3,6,3,6,3], 4, false);
            this.addAnimation("0", [0], 1, false);
            playLastDisplay();
            this.kill();
        }
        ...
        override public function preUpdate():void {
            if (stopWatchTimer.getRemainingSteps() != lastDisplay) {
                lastDisplay = stopWatchTimer.getRemainingSteps();
                playLastDisplay();
            }
            super.preUpdate();
        }
